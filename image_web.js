...
var wasmBinaryFile = "image_web.wasm";
...
var real__process_jpg = asm["process_jpg"];
asm["process_jpg"] = function() {
  assert(
    runtimeInitialized,
    "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
  );
  ...
  return real__process_jpg.apply(null, arguments);
};
...
var _process_jpg = (Module["_process_jpg"] = function() {
  assert(
    runtimeInitialized,
    "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
  );
  ...
  return Module["asm"]["process_jpg"].apply(null, arguments);
});
